  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="bg-gray-800 bg-opacity-70 rounded-md p-6 border border-gray-700 space-y-6">
        ...
        <section>
          <h3 className="text-lg font-semibold text-gray-200 mb-3">Data Storage & Security</h3>
          <div className="text-gray-300 text-sm space-y-2">
            <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <section>
          <h3 className="text-lg font-semibold text-gray-200 mb-3">Your Rights</h3>
          <div className="text-gray-300 text-sm space-y-2">
        ...
        <section>
          <h3 className="text-lg font-semibold text-gray-200 mb-3">Children's Privacy</h3>
        ...
        <section>
          ...
          <div className="text-gray-300 text-sm space-y-2">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span>Email: privacy@hamradiolicense.app</span>
            </div>
          </div>
        </section>

        <section>
          <h3 className="text-lg font-semibold text-gray-200 mb-3">Changes to This Policy</h3>
          <div className="text-gray-300 text-sm">
